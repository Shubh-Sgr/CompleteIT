  ...
  return <div className="space-y-20 pb-8 sm:space-y-28">
    <section className="hero-shell min-h-[36rem] px-6 py-12 text-white sm:px-12 sm:py-16 lg:grid lg:grid-cols-[1.12fr_.88fr] lg:items-center lg:px-16">
      <div className="relative z-10 max-w-3xl">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-xs font-bold text-violet-100 backdrop-blur"><Sparkles size={14}/> AI that completes the picture</div>
        <h1 className="mt-7 text-[clamp(3rem,7vw,6.3rem)] font-black leading-[.88] tracking-[-.07em] text-balance">Everything you need.<br/><span className="bg-gradient-to-r from-violet-300 via-white to-orange-200 bg-clip-text text-transparent">Nothing you don’t.</span></h1>
        ...
        <div className="mt-9 flex flex-col gap-3 sm:flex-row">
          <Link href="/create" className="btn-primary !min-h-14 !bg-white !px-6 !text-base !text-indigo-950 !shadow-[0_18px_40px_rgba(0,0,0,.2)]"><Camera size={20}/>{hasDraft?"Continue building":"Build my first set"}<ArrowRight size={18}/></Link>
